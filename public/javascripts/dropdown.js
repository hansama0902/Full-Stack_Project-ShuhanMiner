document.addEventListener("DOMContentLoaded", () => {
    ...
    if (addMachineToggle && addMachineContainer) {
        ...
        addMachineToggle.addEventListener("click", (event) => {
            ...
            console.log("✅ Add Machine Form Toggled:", addMachineContainer.classList.contains("d-none") ? "Hidden" : "Visible");
        });
    } else {
        console.error("❌ Error: 'toggle-add-machine' or 'add-machine-container' not found.");
    }
});
